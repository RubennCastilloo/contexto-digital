...
?>
	...
	<section class="ptb-0">
		...
		<div class="container">
			...
			<a class="mt-10 color-ash" href="#">Nacional</a>
		</div><!-- container -->
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<h4 class="p-title"><b>NOTAS LOCALES</b></h4>
					<div class="row">
					...
					<a class="dplay-block btn-brdr-primary mt-20 mb-md-50" href="#"><b>CARGAR MÁS NOTAS</b></a>
				</div><!-- col-md-9 -->
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50">
							<h4 class="p-title"><b>ÚLTIMAS NOTICIAS</b></h4>
